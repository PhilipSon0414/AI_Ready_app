...
const STAGES = [
  {
    title: '샌드위치 만들기',
    description: '미션: 맛있는 피넛버터 잼 샌드위치를 완성하세요!',
    items: '준비물: 식빵 1봉지(묶여있음), 잼통(뚜껑 닫힘), 버터나이프, 접시',
    quickCommands: ['집어', '열어', '꺼내', '올려놔', '발라', '덮어', '먹어', '잘라'],
    concept: {
      title: '순차(Sequence)',
      desc: '컴퓨터는 명령을 위에서 아래로 순서대로 실행해요. 샌드위치처럼 "뚜껑 열기 → 잼 꺼내기 → 바르기" 순서가 바뀌면 실패하죠! 이게 바로 알고리즘의 핵심, 순차 실행이에요.',
    },
  },
  {
    title: '컵라면 끓이기',
...
핵심 규칙:
1. 명령에 명시되지 않은 행동은 절대 유추하지 마세요. 예: "잼을 발라" → 잼 뚜껑을 여는 명령이 없었으므로 닫힌 잼통을 식빵에 문지릅니다.
